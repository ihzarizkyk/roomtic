			...
			<div class="col-md-6 mt-5">
				<div class="card p-5 mb-4 mt-4 bg-light rounded-3">
					...
					<div class="card-body">
						...
						<form class="form" action="/postRoom" method="POST">
							@csrf
							...
							<div class="form-floating mb-3">
								<input type="number" class="form-control" id="floatingInput" name="capacity" required>
								<label for="floatingInput"><i class="bi bi-person-vcard-fill"></i> Capacity</label>
							</div>
							...
							<div class="form-floating mb-3">
								...
								<label for="floatingInput"><i class="bi bi-person"></i> Room Name </label>
							</div>
							...
							<a href="{{ route('dashboard.room') }}" class="btn btn-dark btn-md d-flex justify-content-center mt-3">
								Back to Room
							</a>
